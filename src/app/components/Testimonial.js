  ...
  return (
    <div id="myCarousel" className="carousel mb-4 slide" data-ride="carousel" data-interval="false">
      <div className="carousel-inner"><h3 className='text-center myh pt-5'>Customer Review</h3><p className='text-center myhh'>What our customers are saying....</p>
        ...
        <div className="carousel-caption">
          <p className='vh  '>If you like to have a peaceful weekend. This is definitely the right place to go to! i loved everything about this place. The location, the ambience, the hospitality, the price, cleanliness. Everything about this homestay is perfect. The hosts are very sweet and approachable. Veg dishes prepared by them were really tasty. Especially the bajji. It's a couple friendly and family friendly environment. Best thing that i liked about this place is the host really respect guest's privacy. They have separate bonfires for each group of guests. Additionally you will also love whole route to reach the place as it is a little remotely located. All in all a very good experience! will definitely visit again.</p>
        ...
        <div className="carousel-item">
        <div className="carousel-caption">
          <p className='vh  '>They were extremely accommodating and allowed us to check in early at like 10am. We got to hotel super early and i didn’t wanna wait. So this was a big plus. The sevice was exceptional as well. Would definitely send a friend there. Special thanks to prashant. This is the review only</p>
